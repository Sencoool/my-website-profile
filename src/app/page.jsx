...
export default function Home() {
  ...
  return (
    ...
    <main id='about' className="flex flex-col items-center min-h-screen bg-white">
      {/* Profile Section*/}
      <div className="flex flex-col md:flex-row items-center justify-center gap-16 bg-gray-100 shadow-lg shadow-orange-600 rounded-3xl overflow-hidden p-16 border border-gray-200 max-w-7xl w-full mt-20"> 
      <div className="flex justify-center max-w-4/5 slide-in-left"> {/* เพิ่ม Animation */}
      <img src="me.png" className="object-cover overflow-hidden rounded-full border-8 border-orange-400"  alt="Jiramet Profile"/>
        </div>

        {/*Profile Info*/}
        <div className="text-center md:text-left max-w-2xl slide-in-left"> {/* เพิ่ม Animation */}
      ...
      {/* Education Section */}
      <div className="flex flex-col items-center w-full py-10 px-6 fade-in"> {/* เพิ่ม Animation */}
      ...
      {/* Projects Section */}
      <div id='projects' className="flex flex-col items-center w-full bg-gray-100 py-24 px-6 slide-in-bottom fade-in"> {/* เพิ่ม Animation */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full md:w-4/5 lg:w-3/4">
          ...
          <div className="w-full p-6 bg-white rounded-lg shadow-md">
            ...
            <div className="flex flex-col md:flex-row gap-2 md:gap-4">
              ...
              <a href="https://github.com/Sencoool/Express_Streaming_Server" className="bg-orange-500 text-white py-2 px-4 rounded-lg hover:bg-orange-600 transition-colors">
                <img src="github.png" alt="GitHub Logo" className="inline-block w-5 h-5 mr-2" />
                View Back-end
              </a>
            </div>
          ...
          <div className="w-full p-6 bg-white rounded-lg shadow-md">
            ...
            <div className="flex flex-col md:flex-row gap-2 md:gap-4">
              ...
              <a href="https://my-league-quiz.vercel.app" className="bg-orange-500 text-white py-2 px-4 rounded-lg hover:bg-orange-600 transition-colors">
                🎮 Play here !
              </a>
            </div>
          </div>
